...
class _HomeBodyState extends State<HomeBody> {
  ...
  Widget build(BuildContext context) {
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: isGuardian ? Color(0xFF4C433F) : Color(0xFFDAD4CB),
              borderRadius: BorderRadius.only(
                ...
                Padding(
                  ...
                  child: Align(
                    ...
                    child: Text(
                      '선호지역 | 선호요일 | 선호시간',
                      style: TextStyle(
                        color: isGuardian ? Colors.white : Color(0xFF4C433F),
                        fontSize: 15,
                        fontFamily: 'NotoSansKR',
                        fontWeight: FontWeight.w700,
                        height: 0,
                    ...
                    children: profileHashtags.map((hashtag) {
                      return Padding(
                        ...
                        child: CustomBasicContainer(
                          width: 71,
                          height: 29,
                          color: isGuardian ? Color(0xFFDAD4CB) : Color(0xFF4C433F),
                          circularBorderRadius: 12.5,
                          child: Text(
                            '# $hashtag',
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: TextStyle(
                              color: isGuardian ? Color(0xFF4C433F) : Colors.white,
                              fontSize: 15,
                              fontFamily: 'NotoSansKR',
                              fontWeight: FontWeight.w400,
                              height: 0,
    ...
    return Scaffold(
      backgroundColor: isGuardian ? CustomColor.lightBackgroundColor : CustomColor.darkBackgroundColor,
      // body: OnboardingSteps(),
      body: Stack(
        children: [
          SingleChildScrollView(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(17, 50, 17, 50),
              child: Column(
                children: [
                  Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      Image.asset(isGuardian ? 'assets/images/light_screen_text_logo.png' : 'assets/images/dark_screen_text_logo.png', width: 84),
                      SizedBox(height: 40),
                      changeMode(),
                      SizedBox(height: 25),
                      isGuardian ? profileCard() : searchCard(),
                      SizedBox(height: 77),
                      isGuardian ? regionSuggestion() : profileCard(),
                    ],
                  ),
                ],
              ),
