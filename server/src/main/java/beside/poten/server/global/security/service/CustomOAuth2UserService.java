package beside.poten.server.global.security.service;
...
import beside.poten.server.global.oauth.dto.OAuthAttributes;
import beside.poten.server.global.oauth.entity.CustomOAuth2User;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private User getUser(OAuthAttributes attributes, SocialType socialType) {
        User findUser = userRepository.findBySocialTypeAndOauth2Id(socialType,
